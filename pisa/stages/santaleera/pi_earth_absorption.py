...
The earth layer part is ripped straight from pi_prob3.
This needs ROOT. 
"""
...
def calculate_integrated_rho(layer_dists, layer_densities, out):
    ...
    """
    out[0] = np.sum(layer_dists*layer_densities)*1e5 #distances are converted from km to cm
...
def calculate_survivalprob(int_rho, xsection, out):
    ...
    # After thinking about it for a bit, you see why this makes sense: 
